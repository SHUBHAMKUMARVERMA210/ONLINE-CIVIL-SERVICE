...
<body style=" margin-left:0px;">
    <form id="form1" runat="server">
     <!--NAVIGATION BAR-->
       ...
       <asp:LinkButton ID="LNK_BTN_Log_out" runat="server" ForeColor="#000099" 
         ...
         <asp:LinkButton ID="LNK_BTN_Shopkeeper_Log" runat="server" 
         ForeColor="#000099" onclick="LNK_BTN_Shopkeeper_Log_Click">Shopkeeper Log</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
        RepeatColumns="4" onitemcommand="DataList1_ItemCommand" BorderColor="Black" RepeatDirection="Horizontal" 
      ...
      <ItemTemplate>
          <table class="table-hover table-success" border="2" bgcolor="#666666">
              ...
              <tr>
                  <td class="style9"> 
                      <asp:Label ID="Rs_LBL" runat="server" Text="Rs."></asp:Label>
              ...
              <tr>
                  <td class="style9">
                      <asp:Button ID="BTN_Buy_now" runat="server" Text="Buy now" class="btn btn-success" 
                           CommandName="buy now" CommandArgument='<%# Eval("PRODUCT_ID") %>' />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
         ...
         SelectCommand="SELECT * FROM [PRODUCT] WHERE ([CATEGORY] = @CATEGORY) AND ([TYPE] = @TYPE) AND ([SPECIFICATION] = @SPECIFICATION) AND QUANTITY!='0'">
        <SelectParameters>
        <asp:ControlParameter ControlID="DDL_CATEGORY" Name="CATEGORY" Type="String" />
        <asp:ControlParameter ControlID="DDL_TYPE" Name="TYPE" Type="String" />
        <asp:ControlParameter ControlID="DDL_SPECIFICATION" Name="SPECIFICATION" Type="String" />
        </SelectParameters>
     </asp:SqlDataSource>
&nbsp;&nbsp;&nbsp;
<!-- well-->
